...
const ContactOrb = dynamic(() => import("@/components/three/ContactOrb"), {
  ssr: false,
});
    ...
    >
      ...
      >
        ...
        <motion.a
          ...
          className="inline-block font-display font-semibold mb-12"
          style={{
        ...
        >
          <SocialLink
            href="https://linkedin.com/in/kanwar-kelide"
            label="LinkedIn"
          />
          <SocialLink
            href="https://github.com/KanwarKelide"
            label="GitHub"
          />
...
function SocialLink({ href, label }: { href: string; label: string }) {
  return (
    <motion.a
      ...
      whileHover={{ y: -2, color: "#a5b4fc" }}
      className="font-display font-medium text-sm tracking-wide transition-colors duration-200"
